...
<form  name="form_data_buyer" enctype="multipart/form-data" action="buyer_add_order.php" method="POST" class="form-horizontal">
       <div class="form-group row">
          ...
          <div class="col-sm-5" align="left">
            <input  name="m_name" type="text" required class="form-control" id="m_name" value="" />
          </div>
      </div> 
      <div class="form-group row">
          <div class="col-sm-2" >เบอร์ติดต่อ :</div>
          <div class="col-sm-5" align="left">
            <input  name="m_tel" type="text" required class="form-control" id="m_tel"  />
          </div>
      </div> 
      <div class="form-group row">
          <div class="col-sm-2" >E-mail :</div>
          <div class="col-sm-5" align="left">
            <input  name="m_email" type="text" required class="form-control" id="m_email"  value="คำสั่งซื้อหน้าร้าน" />
          </div>
      </div> 
      <div class="form-group row">
          <div class="col-sm-2" >ที่อยู่ :</div>
          <div class="col-sm-5" align="left">
            <textarea name="m_address" rows="5" class="form-control">-</textarea>
          </div>
      </div> 
      <hr>
      <div class="form-group row">
      ...
      <div class="form-group row hide" id="div1" >
        ...
        <input type="hidden" id="pay_type" name="pay_type" value="cash"> 
