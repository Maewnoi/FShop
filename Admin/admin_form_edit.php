...
<input  type="hidden" name="a_id" value="<?php echo $a_id; ?>">
          <div class="row">
            ...
            <div class="col-sm-6" align="left">
              <input  name="a_user" type="text" required class="form-control" id="a_user" value="<?=$a_user;?>"minlength="2"  />
            </div>
          </div>
          <br>
          <div class="row">
            ...
            <div class="col-sm-6" align="left">
              <input  name="a_pass" type="password" required class="form-control" id="a_pass" value="<?=$a_pass;?>" minlength="2" />
            </div>
          </div>
          <br>
          <div class="row">
